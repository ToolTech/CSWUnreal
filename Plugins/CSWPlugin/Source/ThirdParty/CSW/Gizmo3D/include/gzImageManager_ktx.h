...
//
//
// File			: gzImageManager_ktx.h
// Module		: 
// Description	: Class definition of the ktx format reader
// Author		: Anders Modén		
...
//
//******************************************************************************
#ifndef __GZ_IMAGE_KTX_H__
#define __GZ_IMAGE_KTX_H__
...
class gzImageManager_ktx : public gzImageManager	
{
public:

	GZ_IMAGE_EXPORT gzImageManager_ktx();

	GZ_IMAGE_EXPORT virtual ~gzImageManager_ktx(){};
