...
class gzImageManager_dds : public gzImageManager	
{
public:

	GZ_IMAGE_EXPORT gzImageManager_dds();

	GZ_IMAGE_EXPORT virtual ~gzImageManager_dds(){};
