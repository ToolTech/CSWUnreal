...
enum gzKeyValue 
{
	...
	GZ_KEY_F1 = 0x1000,GZ_KEY_F2,GZ_KEY_F3,GZ_KEY_F4,GZ_KEY_F5,GZ_KEY_F6,
	...
	// Mouse keys
	GZ_KEY_LBUTTON,GZ_KEY_MBUTTON,GZ_KEY_RBUTTON ,

	// Num keys
	GZ_KEY_MULTIPLY,GZ_KEY_ADD,GZ_KEY_SEPARATOR,GZ_KEY_SUBTRACT,GZ_KEY_DECIMAL,GZ_KEY_DIVIDE,
