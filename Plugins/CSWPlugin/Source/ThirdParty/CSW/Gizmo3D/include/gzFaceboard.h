...
//
//******************************************************************************
#ifndef __GZ_FACEBOARD_H__
#define __GZ_FACEBOARD_H__

/*!	\file 
	\brief Definitions of gzFaceboard
...
struct gzFaceboardObjectData
{
	gzFaceboardObjectData()
	{
		sizeAsp=((gzInt32)(1.0f*1000))*100.0f+1.0f;	// Size 1, Aspect 1
		heading=0;
		pitch=0;
		roll=0;
	}
...
//									
//******************************************************************************
class gzFaceboard : public gzBaseGeometry
{
public:
	GZ_GRAPH_EXPORT gzFaceboard(const gzString & name=GZ_EMPTY_STRING);

	GZ_GRAPH_EXPORT virtual ~gzFaceboard();
	...
	GZ_GRAPH_EXPORT gzVoid	setObjectAspect(gzUInt32 object,const gzFloat &aspect);
	GZ_GRAPH_EXPORT gzFloat	getObjectAspect(gzUInt32 object);
	...
	GZ_GRAPH_EXPORT gzVoid	randomize();
...
private:
	...
	gzArray<gzFaceboardObjectData>		m_objectData;	// Object data
...
GZ_DECLARE_REFPTR(gzFaceboard);

#endif // __GZ_FACEBOARD_H__
