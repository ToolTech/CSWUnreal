...
//
//
// File			: gzImageManager_pfi.h
// Module		: 
// Description	: Class definition of the pfi format reader
// Author		: Anders Modén		
...
//									
// AMO	001228	Created file 	
//
//******************************************************************************
#ifndef __GZ_IMAGE_PFI_H__
#define __GZ_IMAGE_PFI_H__

/*!	\file 
	\brief Base definitions of a pfi bitmap reader
...
class gzImageManager_pfi : public gzImageManager	
{
public:

	GZ_IMAGE_EXPORT gzImageManager_pfi();

	GZ_IMAGE_EXPORT virtual ~gzImageManager_pfi(){};
